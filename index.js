...
async function init() {
    ...
    const computer = await fetch('https://reactmarathon-api.herokuapp.com/api/mk/player/choose').then(res => res.json());


    localStorage.setItem('player2', JSON.stringify(computer));
